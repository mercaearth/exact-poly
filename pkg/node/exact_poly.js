 ...
 * @returns {bigint}
 */
function area_display_from_twice_area(twice_area, config) {
...
exports.area_display_from_twice_area = area_display_from_twice_area;
 ...
 * @returns {boolean}
 */
function areas_conserved_values(original, part_areas) {
...
exports.areas_conserved_values = areas_conserved_values;
 ...
 * @returns {any}
 */
function bayazit_decompose_polygon(ring_flat, allow_steiner) {
...
exports.bayazit_decompose_polygon = bayazit_decompose_polygon;
 ...
 * @returns {string}
 */
function classify_contact(a_flat, b_flat) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.classify_contact = classify_contact;
 ...
 * @returns {any}
 */
function collect_steiner_points(ring_flat, parts_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.collect_steiner_points = collect_steiner_points;
 ...
 * @returns {boolean}
 */
function collinear_segments_overlap_area(a1x, a1y, a2x, a2y, b1x, b1y, b2x, b2y, a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.collinear_segments_overlap_area = collinear_segments_overlap_area;
 ...
 * @returns {boolean}
 */
function contains_polygon(outer_parts_flat, inner_parts_flat) {
...
exports.contains_polygon = contains_polygon;
 ...
 * @returns {boolean}
 */
function convex_parts_overlap(a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.convex_parts_overlap = convex_parts_overlap;
 ...
 * @returns {any}
 */
function decompose_polygon(ring_flat, allow_steiner, collect_trace, minimize_parts, config) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.decompose_polygon = decompose_polygon;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {any}
 */
function ear_clip_triangulate_polygon(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.ear_clip_triangulate_polygon = ear_clip_triangulate_polygon;
 ...
 * @returns {string}
 */
function edge_squared_length(ax, ay, bx, by) {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.edge_squared_length = edge_squared_length;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {any}
 */
function ensure_ccw(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
function exact_partition_only_original_vertices(ring_flat, parts_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.exact_partition_only_original_vertices = exact_partition_only_original_vertices;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {any}
 */
function exact_vertex_partition_polygon(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.exact_vertex_partition_polygon = exact_vertex_partition_polygon;
 ...
 * @returns {any}
 */
function find_overlapping_parts(a_parts_flat, b_parts_flat) {
...
exports.find_overlapping_parts = find_overlapping_parts;
 ...
 * @returns {boolean}
 */
function has_exact_shared_edge(a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.has_exact_shared_edge = has_exact_shared_edge;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {boolean}
 */
function is_ccw(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
function is_collinear_pts(ax, ay, bx, by, px, py) {
    const ret = wasm.is_collinear_pts(ax, ay, bx, by, px, py);
    return ret !== 0;
}
exports.is_collinear_pts = is_collinear_pts;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {boolean}
 */
function is_convex(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
function is_left_or_on(ax, ay, bx, by, px, py) {
    const ret = wasm.is_left_or_on(ax, ay, bx, by, px, py);
    return ret !== 0;
}
exports.is_left_or_on = is_left_or_on;
 ...
 * @returns {boolean}
 */
function is_reflex(prev_x, prev_y, curr_x, curr_y, next_x, next_y) {
    const ret = wasm.is_reflex(prev_x, prev_y, curr_x, curr_y, next_x, next_y);
    return ret !== 0;
}
exports.is_reflex = is_reflex;
 ...
 * @returns {boolean}
 */
function is_right_or_on(ax, ay, bx, by, px, py) {
    const ret = wasm.is_right_or_on(ax, ay, bx, by, px, py);
    return ret !== 0;
}
exports.is_right_or_on = is_right_or_on;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {boolean}
 */
function is_simple(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function merge_convex_pair(a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.merge_convex_pair = merge_convex_pair;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {any}
 */
function normalize_polygon(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function optimize_partition(parts_flat) {
...
exports.optimize_partition = optimize_partition;
 ...
 * @returns {boolean}
 */
function parts_overlap(a_parts_flat, b_parts_flat) {
...
exports.parts_overlap = parts_overlap;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {string}
 */
function perimeter_l1(ring_flat) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
...
exports.perimeter_l1 = perimeter_l1;
 ...
 * @returns {boolean}
 */
function point_inside_any_part(parts_flat, x, y) {
...
exports.point_inside_any_part = point_inside_any_part;
 ...
 * @returns {boolean}
 */
function point_inside_or_on_boundary(px, py, ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.point_inside_or_on_boundary = point_inside_or_on_boundary;
 ...
 * @returns {boolean}
 */
function point_on_polygon_boundary(px, py, ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.point_on_polygon_boundary = point_on_polygon_boundary;
...
exports.point_on_segment = point_on_segment;
 ...
 * @returns {boolean}
 */
function point_strictly_inside_convex(px, py, ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.point_strictly_inside_convex = point_strictly_inside_convex;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {any}
 */
function remove_collinear(ring_flat) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.remove_collinear = remove_collinear;
 ...
 * @returns {any}
 */
function rotate_polygon(ring_flat, start) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.rotate_polygon = rotate_polygon;
 ...
 * @returns {boolean}
 */
function sat_overlap(a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.sat_overlap = sat_overlap;
 ...
 * @returns {boolean}
 */
function sat_overlap_with_aabb(a_flat, b_flat) {
    const ptr0 = passArray64ToWasm0(a_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(b_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.sat_overlap_with_aabb = sat_overlap_with_aabb;
 ...
 * @returns {boolean}
 */
function segments_contact(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2) {
    const ret = wasm.segments_contact(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2);
    return ret !== 0;
}
exports.segments_contact = segments_contact;
...
exports.segments_intersect = segments_intersect;
 ...
 * @returns {boolean}
 */
function segments_properly_intersect(a1x, a1y, a2x, a2y, b1x, b1y, b2x, b2y) {
    const ret = wasm.segments_properly_intersect(a1x, a1y, a2x, a2y, b1x, b1y, b2x, b2y);
    return ret !== 0;
}
exports.segments_properly_intersect = segments_properly_intersect;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {string}
 */
function signed_area_2x(ring_flat) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
...
exports.signed_area_2x = signed_area_2x;

/**
 * @param {BigInt64Array} ring_flat
 * @returns {string}
 */
function twice_area(ring_flat) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
 ...
 */
function validate_compactness(twice_area, perimeter, config) {
    const ptr0 = passStringToWasm0(twice_area, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.validate_compactness = validate_compactness;
 ...
 * @returns {any}
 */
function validate_decomposition(ring_flat, parts_flat, config) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.validate_decomposition = validate_decomposition;
 ...
 * @returns {string | undefined}
 */
function validate_edge_lengths(ring_flat, config) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.validate_edge_lengths = validate_edge_lengths;
 ...
 * @returns {any}
 */
function validate_multipart_topology(parts_flat, allow_vertex_contact, config) {
...
exports.validate_multipart_topology = validate_multipart_topology;
 ...
 * @returns {string | undefined}
 */
function validate_part(ring_flat, config) {
    const ptr0 = passArray64ToWasm0(ring_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.validate_part = validate_part;
...
const wasmPath = `${__dirname}/exact_poly_bg.wasm`;
