...
export function ensure_ccw(ring_flat: BigInt64Array): any;
...
export function normalize_polygon(ring_flat: BigInt64Array): any;
...
export function remove_collinear(ring_flat: BigInt64Array): any;

export function rotate_polygon(ring_flat: BigInt64Array, start: number): any;
 ...
 */
export function validate_compactness(twice_area: string, perimeter: string, config?: any | null): string | undefined;

export function validate_decomposition(ring_flat: BigInt64Array, parts_flat: any, config?: any | null): any;

export function validate_edge_lengths(ring_flat: BigInt64Array, config?: any | null): string | undefined;
 ...
 */
export function validate_part(ring_flat: BigInt64Array, config?: any | null): string | undefined;
